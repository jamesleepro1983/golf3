export default function NextJsBadge() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-[#1a1a1a] border border-white/10 px-3 py-2 opacity-40 hover:opacity-100 transition-opacity group"
    >
      ...
      <span className="text-[0.65rem] font-medium tracking-wider text-offwhite uppercase">Made in Next.js</span>
    </a>
  )
}
